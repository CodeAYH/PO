object FormTowerSet: TFormTowerSet
  Left = 0
  Top = 0
  BorderStyle = bsNone
  BorderWidth = 1
  Caption = 'FormTowerSet'
  ClientHeight = 213
  ClientWidth = 554
  Color = clSilver
  ...
  object TowerLampGrid: TAdvStringGrid
    Left = 1
    Top = 2
    Width = 554
    Height = 152
    ...
    ScrollBars = ssNone
    TabOrder = 2
    OnGetCellColor = TowerLampGridGetCellColor
    OnGetAlignment = TowerLampGridGetAlignment
    OnCanClickCell = TowerLampGridCanClickCell
    OnCanEditCell = TowerLampGridCanEditCell
    OnGetEditorType = TowerLampGridGetEditorType
    OnGetEditorProp = TowerLampGridGetEditorProp
