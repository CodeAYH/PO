object FmTCardRecipeLoading: TFmTCardRecipeLoading
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object TCardInputGrid: TAdvStringGrid
    Left = 1
    Top = 8
    Width = 240
    Height = 451
    ...
    ParentFont = False
    TabOrder = 0
    OnCanEditCell = TCardInputGridCanEditCell
  ...
  object InputTCardEdit: TLabeledEdit
    ...
    EditLabel.Width = 109
    EditLabel.Height = 23
    EditLabel.Caption = 'Input T-Card'
